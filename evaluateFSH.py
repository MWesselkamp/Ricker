...
def generate_data(years = 2, init = 0.99, state = "stable"):
...
def eval_fsh(metric = "crps", years = 2, state ="stable"):
    ...
    xobs, xpreds, climatology_today = generate_data(years = years, init = init, state =state)
...
if __name__=="__main__":
    ...
    for m in metrics:
        eval_fsh(m, years=1, state="instable")
        eval_fsh(m, years=2, state="stable")
