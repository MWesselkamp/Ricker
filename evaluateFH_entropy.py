...
plt.tight_layout()
fig.show()
fig.savefig(os.path.abspath(f"{pathname}/general/raw_scatter1.pdf"))
...
plt.tight_layout()
fig.show()
fig.savefig(os.path.abspath(f"{pathname}/general/raw_scatter2.pdf"))
...
plt.tight_layout()
fig.show()
fig.savefig(os.path.abspath(f"{pathname}/general/norm_fit.pdf"))
...
plt.tight_layout()
fig.show()
fig.savefig(os.path.abspath(f"{pathname}/kldivergence.pdf"))